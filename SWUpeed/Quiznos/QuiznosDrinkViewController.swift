...
//
//  QuiznosDrinkViewController.swift
//  SWUpeed
//
...
class QuiznosDrinkViewController: UIViewController {

    var detailVC: QuiznosDrinkTableViewController?
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "ToOptionDetail"{
            let dest = segue.destination as! QuiznosDrinkTableViewController
