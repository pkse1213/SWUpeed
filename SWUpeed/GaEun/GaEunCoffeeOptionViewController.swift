//
//  GaEunCoffeeOptionViewController.swift
//  SWUpeed
//
...
class GaEunCoffeeOptionViewController: UIViewController {
    var detailVC: GaEunCoffeeOptionTableViewController?
    ...
    @IBAction func cartAdd(_ sender: UIButton) {
        ...
        let menu = Menu(storeName:"[가은]", menuName: menuName , size: sizeDic, options: optionDic, totalPrice: price)
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "ToOptionDetail"{
            let dest = segue.destination as! GaEunCoffeeOptionTableViewController
